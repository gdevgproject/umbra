...
| Genshin Impact | third-person action, party/build synergy, traversal | action/readability/loadout và movement resource tạo trade-off gì? | `SOURCE_SEED`; camera/traversal plans; exact mechanic cần build capture |
