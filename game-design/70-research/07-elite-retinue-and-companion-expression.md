...
UMBRA nên giới hạn Shadow ở đâu để từng cá thể sâu, đội hình đọc được và AI phối hợp tốt; quỳ/cúi/biểu cảm nên vận hành thế nào để tạo attachment mà không spam hoặc cắt gameplay?
...
| Một companion có nguy cơ làm lu mờ protagonist | companion power phải có vai trò, cap và player agency | reserve thứ năm không đóng góp combat power | Self/Retinue balance simulation |
...
- **Đã khóa ở Product:** roster tối đa năm; active combat tối đa bốn; slot thứ năm mở rất muộn và là dự bị chiến lược.
- **Lý do:** năm member cho tối đa mười cặp quan hệ—một scope hữu hạn cho authored depth; active four giữ combat composition/command trong một nhóm nhỏ; reserve tạo lựa chọn mà không cộng actor thứ năm vào mọi trận.
- **Hypothesis cần prototype:** `UNRESOLVED_CLAIM` cap một bảo vệ rare capture khi roster đầy mà không tạo kho quân đoàn; slot 2–5 mở qua capability/mastery milestones; expression coordinator làm nghi lễ hiếm và personality rõ hơn.
...
- **Confidence:** cao cho nguyên lý bounded active party, reservation/context và anti-spam; trung bình cho cap chính xác `5/4` cho tới prototype UMBRA.
- **Missing comparison:** Minecraft first/third-person room, beast/flying Shadow topology, home scene năm member, full-roster rare boss scenario.
