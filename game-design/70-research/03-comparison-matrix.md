# RES-MATRIX — Ma trận so sánh mechanic
...
| Minecraft transfer | block, vanilla action, server tick, multiplayer/save/perf? |
| Originality | principle nào giữ; form/premise/consequence nào phải đổi? |
| Evidence | clip/timecode/build/test và hạn chế? |

Không chấm tổng điểm mơ hồ. Criteria có trọng số theo Feature Cell; option thất bại invariant bị loại dù “feel” hấp dẫn.
