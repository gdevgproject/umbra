...
| 18 | `DB-050` | Free Climb geometry/profile/revision, Jump/Sneak context + intent lineage/inhibitor, targeted leap/dyno/eject, mantle/buffer/assist, hybrid Vigor/recovery/HUD, build/hit/fluid/piston/mode race, animation/camera/prediction/comfort hoạt động chính xác ra sao? | Traversal + Controls + UI + Animation + World + Platform | `DB-004`, `DB-025`, `DB-029`, `DB-048`, `DB-049` | Free Climb Feature Cell + ADR-0004 + one-edge-one-consumer/entry/leap/Vigor/HUD/voxel mutation/prediction/feel validation package |
...
| 28 | `DB-051` | Hạ Kình dùng time-to-impact/Vigor/weapon adapter/fall conversion/AoE nào để phản xạ đáng tin nhưng không auto-save? | Traversal + Combat + Animation + Balance | `DB-003`, `DB-025`, `DB-046`, `DB-049`, `DB-050` | Grounding Strike Feature Cell + fall/action/hit proof |
...
| 30 | `DB-052` | Khinh Công launch–apex–descent/steering/Vigor/collision/combat interaction và early progression nào tạo tự do mà không thành flight? | Traversal + Controls + World + Balance | `DB-002`, `DB-025`, `DB-037`, `DB-048`, `DB-049`, `DB-050`, `DB-051` | Lightness Feature Cell + trajectory/world validation package |
