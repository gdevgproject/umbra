...
| 18 | `DB-050` | Free Climb attach/input, vertical/lateral/leap/corner/mantle/collision/animation/comfort hoạt động chính xác ra sao? | Traversal + Controls + Animation | `DB-004`, `DB-025`, `DB-029`, `DB-048`, `DB-049` | Free Climb Feature Cell + voxel-room validation package |
