...
| `C2B-VERTICAL-FREEDOM` | trong voxel traversal room, player dùng basic mantle + Free Climb dọc/ngang/leap để vượt một vách rồi quay về xây/đào bình thường | `CTR-TRAVERSAL`, surface/ledge profiles, Khí Lực, climb input/camera/animation/collision, authority/save/debug; capability flag thay production quest | geometry/state/resource/duplicate/lifecycle fixtures, first/third comfort, `PERF-S09A`, no-clip/no-refill proof |
...
| `C3B-AERIAL-MASTERY` | player giậm Khinh Công qua khoảng trống, hạ chậm rồi Hạ Kình đáp cạnh combat dummy mà không xuyên block/auto-fly | Lightness launch/apex/descent, Grounding action/fall/AoE, Vigor/camera/input/weapon-animation adapters, world/enemy/follower seams | trajectory/fall/hit/resource/lifecycle/security tests, two-view feel/comfort, sequence-break audit, `PERF-S09B` |
