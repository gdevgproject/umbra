...
- Self và Legion cùng mạnh nhưng không làm một phía vô nghĩa;
...
| Shadows/Legion | kiểm soát chiến trường và fantasy quân đoàn | auto-win hoặc player chỉ đứng nhìn |
...
- context: first/third person, solo/Legion, open world/Gate, terrain/chunk constraints;
...
Damage display là một phần balance evidence: multi-hit/Legion đông phải gộp/cap đủ để player đọc nguyên nhân mà không gây clutter hoặc performance spike. Exact number scale, bar/icon/color/crit/blocked presentation thuộc `DB-042` + UI contract.
