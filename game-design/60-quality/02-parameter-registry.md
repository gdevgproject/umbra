...
| Arise/summon/revive/Domain | `CANDIDATE`; Retinue cap `5/4` là Product topology | Shadows, Combat, Performance |
...
```
Sức chứa kết ước: mở với 1 slot; tiến triển 1 → 2 → 3 → 4 → 5
Triển khai chiến đấu đồng thời: tối đa 4
Slot thứ 5: đột phá muộn, dùng làm dự bị chiến lược; exact milestone/cost = DB-044
