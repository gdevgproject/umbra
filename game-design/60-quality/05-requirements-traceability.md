...
| R06 | Combat mastery, chống spam, Vigor Dodge/parry có cap | Combat + Contracts | action/hit/resource/latency/feel tests |
...
| R48 | Damage/gear/counter/display được quyết từ fantasy/evidence, không phục hồi Primary Attribute/Potential/Posture meter | Player + Balance + Combat + UX | `DB-042`, simulations, multi-build/mastery playtests, legacy-field migration |
...
| R54 | HP + Vigor là hai core meters UMBRA; Mana/Focus/Fatigue/Posture bị xóa và không tái xuất qua skill/save/HUD | `CTR-VITALS-HUD` + Resource + Skills + Combat | schema/import/transaction/property/HUD/migration tests |
...
| R58 | Khí Lực thống nhất Dodge/Sprint Burst/Free Climb/Lightness, tách Minecraft Hunger và không bị relog/refill/cost exploit | `CTR-TRAVERSAL` + Resource + UI + Platform | locked arithmetic, transaction/property/save/reconnect/anti-AFK tests, meter comprehension |
...
| R66 | Level 1→100+ là progression axis duy nhất; skill grant tại L1/mỗi 5 và full-future preview không giấu build | Progression + Skills + UI + Platform | `DB-058`, grant formula/property/migration/missing-content/preview-version tests |
| R67 | Hạ Kình valid impact hãm/lao/cancel fall/AoE theo locked math, không Vigor/block grief/hazard immunity | Grounding + Combat + World + Platform | `DB-051`, 1–100+ swept collision/radius/fall/target/asset/lifecycle tests |
| R68 | Village Hub giữ power silhouette monotonic và upper resident pyramid, không lifecycle/POI/save exploit | World + AI + Platform + Performance | `DB-060`, hub merge-split/unload/quota/property/visual/`PERF-S01` proof |
| R69 | Rare NPC traits tạo xã hội phân hóa nhưng Bully nonlethal, Guardian fair và L70+ self-preserving | AI + World + Combat + Accessibility | `DB-061`, nonlethal/rescue/flee/LOD/seed/comprehension proof |
| R70 | Foundation→Camera/Skills train tạo snapshot mod-equivalent có flag/save/rollback nhưng không fork gameplay truth | Platform + Camera + Skills + Production | C1/C2/C2S ticket packs, architecture/manifest/lifecycle/perf evidence |
