...
| Engineering operations | solo+Agent roles, session bootstrap/cold-agent reconcile, code change-surface discovery, guarded invariants, branch/commit/self-review/handoff, bug workflow | policy ready |
