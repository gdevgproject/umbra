...
| Identity/registry | namespace, stable IDs, version/reference validation | content meaning |
| Config/capability manifest | config layers, validation, feature availability | balance decision |
| Persistence/migration | schema envelope, backup, migration journal, recovery | domain fields không có owner |
