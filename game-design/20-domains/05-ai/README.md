...
- Level 70+ có social stance/archetype đọc được, rare Bully/Guardian variants và self-preservation; personality không được bypass damage/path/action authority.
...
5. [Tính cách NPC theo Level](05-villager-level-personality-and-survival.md)
