...
| `CTR-VITALS-HUD` | Combat Systems + UI/UX | damage, Dodge, skill, item recovery, world hazard, death | one authoritative health, Mana/Focus semantics, fixed-width HUD, environmental mapping | `PROPOSED` |
...
- [Sinh lực, Mana, Focus và HUD chiến đấu](08-vitals-resource-and-hud-contract.md)
