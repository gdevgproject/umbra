...
> Quy ước: `L` = level người chơi · `La` = level mục tiêu (quái) · `⌊x⌋` = floor · `clamp(x,a,b)` = giới hạn trong [a,b].
> **Chuẩn v4.0:** thêm 14.12 (Thể Lực), 14.13 (Tinh Thần địch), 14.14 (Kính Trọng), 14.15 (Thuê Hunter), 14.16 (Giá bán rác); hoàn thiện bảng bonus 14.6.
...
## 14.6. Sức chứa, triệu hồi & tái sinh quân đoàn (chuẩn v4.0)
...
## 14.12. Thể Lực (Fatigue) — chuẩn v4.0 (tài liệu 05.3)
...
## 14.13. Tinh Thần địch (Morale) — chuẩn v4.0 (tài liệu 07.7)
...
## 14.14. Kính Trọng (Respect) — chuẩn v4.0 (tài liệu 10.2.3)
...
## 14.15. Thuê Hunter (Hire) — chuẩn v4.0 (tài liệu 10.2.5)
...
## 14.16. Giá bán "Rác ra Vàng" — chuẩn v4.0 (tài liệu 12.2)
...
## 14.17. Thăng Giới & Thế Giới Song Song — chuẩn v4.0
...
## 14.18. Chỉ số combat có trần cứng đọc được — chuẩn v4.0
...
## 14.19. Focus, dodge và Perception Readout — chuẩn v4.0
...
## 14.20. Monarch's Domain — chuẩn v4.0
...
## 14.21. Gate lifecycle & Soul Echo — chuẩn v4.0
